  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-rice-100 paper-noise dark:bg-charcoal-900">
      ...
      <div className="relative mx-auto w-full max-w-md px-5 py-10">
        <section className="animate-rise overflow-hidden rounded-3xl border border-white/80 bg-white/90 shadow-float backdrop-blur dark:border-rice-100/10 dark:bg-charcoal-700/90">
          {/* 门店图片 */}
          ...
          <div className="px-6 py-8 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-chili-500/20 bg-chili-50 px-3 py-1.5 text-xs font-bold text-chili-600 dark:border-chili-100/25 dark:bg-chili-500/20 dark:text-chili-100">
            ...
            <p className="mt-3 flex items-center justify-center gap-1.5 text-base font-semibold text-charcoal-500 dark:text-rice-200/75">
              <MapPin size={16} className="text-chili-500 dark:text-chili-100" />
